...
namespace FinTrack.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Erro ao carregar informações do login externo.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} logou com {Provider}.",
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Erro ao carregar o login externo durante a confirmação.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("Conta criada usando {Provider}.", info.LoginProvider);
        ...
        private Usuario CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException(
                    $"Unable to create instance of {nameof(Usuario)}.");
            }
        }
